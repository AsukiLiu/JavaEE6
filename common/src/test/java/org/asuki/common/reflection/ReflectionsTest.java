...
public class ReflectionsTest {
    ...
    public void test() {
        ...
        assertThat(getMethodNames(getters).toString(),
                is("[getLocation, getName, getId]"));
        ...
        assertThat(
                getMethodNames(listMethods).toString(),
                is("[removeAll, addAll, containsAll, retainAll, removeAll, addAll, containsAll, retainAll]"));

        Set<Field> fields = getAllFields(Person.class,
                withAnnotation(Option.class),
                withTypeAssignableTo(String.class));

        assertThat(getFieldNames(fields).toString(), is("[name, location]"));
    }
